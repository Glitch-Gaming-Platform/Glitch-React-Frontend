                        ...
                        <div className="uk-width-3-3@l uk-first-column">
                            <div className="widjet --filters">
                                ...
                                <div className="widjet__head">
                                    ...
                                    <h3 className="uk-text-lead">Community</h3>
                                    <div className="uk-width-1-5">
                                        <Create text={"Create Tournament"} onClick={(event) => {navigate(Router.PostsCreatePage())}}></Create>
                                    </div>
                                </div>
                            ...
                            {Posts.map(function (competition, index) {
                                return <GameCard
                                    key={index}
                                    title={competition.name}
                                    description={competition.description}
                                    image={competition.main_image}
                                    link={Router.PostsViewPage(competition.id)}
                                />;
                            })}
                        </div>
