...
const StreamsManage = (props) => {
    ...
    useEffect(() => {
        ...
        Glitch.api.Events.view(id).then(response => {
            ...
            setWidget(<VideoConferencing id={response.data.data.invirtu_id} />);
        ...
        <>
            ...
            <div className="page-content">
                ...
                <main className="page-main">
                    ...
                    <h3 className="uk-text-lead">{stream.title}</h3>
                    <div className="uk-grid uk-grid-small" data-uk-grid="">
                        ...
                        <div className="uk-width-1-3@s">
                            <div className="game-profile-card">
                                <div className="game-profile-card__intro"><span>{stream.description}</span></div>
                                <ul className="game-profile-card__list">
                                    ...
                                    <li>
                                        ...
                                        <div><Moment fromNow>{stream.created_at}</Moment></div>
                                    </li>
                                    <li>
                                        <div>Users:</div>
