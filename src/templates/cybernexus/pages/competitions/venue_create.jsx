...
const CompetitionsVenuesCreate = (props) => {
        ...
        <>
            ...
            <div className="page-content">
                ...
                <main className="page-main">
                    ...
                    <h3 className="uk-text-lead">Create New View</h3>
                        ...
                        <div className="uk-width-2-3@s uk-first-column">
                            ...
                            <div className="gallery">
                                ...
                                <VenueFormAdditional
                                    ...
                                    additionalNotesOnChange={(event) => setAdditionalNotes(event.target.value)}
                                    accessInstructionsValue={venue_access_instructions}
                                    accessInstructionsOnChange={(event) => setVenueAccessInstructions(event.target.value)}
                                    directionInstructionsValue={venue_direction_instructions}
                                    directionInstructionsOnChange={(event) => setVenueDirectionInstructions(event.target.value)}
                                ...
                                <Confirm text={"Create Tournament"} onClick={(event) => createVenue()} />
...
export default CompetitionsVenuesCreate;