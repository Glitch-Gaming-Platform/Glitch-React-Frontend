            ...
            <div className="about-team  padding-bottom padding-top-2" key={'key1'}>
                <div className="container">
                    ...
                    <li className="d-flex align-items-center" key={1}>
                        ...
                        <li className="d-flex align-items-center" key={1}>
                            <a href="https://github.com/Glitch-Gaming-Platform/Glitch-Desktop-App/releases/download/v0.7.0/Glitch-Desktop-App-0.7.0-arm64.dmg">
                        ...
                        <li className="d-flex align-items-center" key={2}>
                            <a href="https://github.com/Glitch-Gaming-Platform/Glitch-Desktop-App/releases/download/v0.7.0/Glitch-Desktop-App-Web-Setup-0.7.0.exe">
