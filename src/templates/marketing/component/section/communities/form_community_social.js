...
export default function CommunityFormBasic({ nameValue, nameOnChange, descriptionValue, descriptionOnChange, subdomainValue, subdomainOnChange, venueTypeValue, venueTypeOnChange, errors }) {
