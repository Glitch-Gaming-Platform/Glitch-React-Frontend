                        ...
                        <div className="authors list-group-item" key={index}>
                            <div className="d-flex align-items-center">
                                ...
                                <div className="author-content text-white">
                                    <h6 className="mb-2">{influencer.user.username} {getStatusBadge(influencer.acceptance_status)}</h6>
                                    
                                    <Link className="btn btn-info me-2" to={Navigate.campaignsResearchInfluencer(campaign_id, influencer.user.id)}>
                                    ...
                                    {influencer.acceptance_status !== 1 && (
                                        <div className='mb-3'>
                                            <p className="small">Change approval status.</p>
