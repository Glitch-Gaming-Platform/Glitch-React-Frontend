        ...
        return (
            <Fragment>
                ...
                <div className="container mt-5">
                    ...
                    <p>This Agreement explains your rights and obligations in using the Glitck platform (hereafter referred to as "the Services"). By clicking “Accept”, submitting information, or continuing to use the Services, you confirm that you have read and understand this Agreement.</p>
                    ...
                    <p><strong>DISPUTE RESOLUTION – VENUE.</strong> Any disputes will be resolved in Connecticut unless otherwise agreed upon by Invirtu Labs, Inc.</p>
